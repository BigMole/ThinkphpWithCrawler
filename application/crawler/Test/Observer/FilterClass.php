...
<head>
<meta charset="utf-8">
<title>Flat UI - 免费的 Bootstrap 主题</title>
<meta name="description" content="Flat UI是一套精美的扁平风格 UI 工具包，基于 Twitter Bootstrap 实现。这套界面工具包含许多基本的和复杂的 UI 部件，例如按钮，输入框，组合按钮，复选框，单选按钮，标签，菜单，进度条和滑块，导航元素等等。"/>
...
<h1 class="demo-section-title">基本元素</h1>
<h3 class="demo-panel-title">按钮</h3>
...
<h3 class="demo-panel-title">输入框</h3>
<div class="row">
<div class="col-xs-3">
...
<div class="row">
<div class="col-xs-3">
<h3 class="demo-panel-title">下拉菜单</h3>
<div class="btn-group">
...
<div class="col-xs-3">
<h3 class="demo-panel-title">选项</h3>
...
<div class="row">
<div class="col-xs-5">
<h3 class="demo-panel-title">进度条 &amp; 滑块</h3>
<div class="progress">
...
<h3 class="demo-panel-title">导航</h3>
...
<div class="col-xs-3">
<h3 class="demo-panel-title">单选按钮</h3>
<label class="radio">
...
<div class="col-xs-3">
<h3 class="demo-panel-title">开关</h3>
<table width="100%">
<tr>
...
<div class="col-xs-3">
<h3 class="demo-panel-title">分享</h3>
<div class="share mrl">
<ul>
<li>
...
<h3 class="demo-panel-title">标题</h3>
</div>
<div class="demo-content">
<div class="demo-type-example">
<h1><span class="demo-heading-note">标题 1</span>Showers across the W</h1>
</div>
<div class="demo-type-example">
<h2><span class="demo-heading-note">标题 2</span>Give this quartet a few</h2>
</div>
<div class="demo-type-example">
<h3><span class="demo-heading-note">标题 3</span>The Vatican transitions to a</h3>
</div>
<div class="demo-type-example">
<h4><span class="demo-heading-note">标题 4</span>Great American Bites: Telluride\'s Oak, The</h4>
</div>
<div class="demo-type-example">
<h5><span class="demo-heading-note">标题 5</span>Author Diane Alberts loves her some good</h5>
</div>
<div class="demo-type-example">
<h6><span class="demo-heading-note">标题 6</span>With the success of young-adult book-to-movie</h6>
</div>
<div class="demo-type-example">
<span class="demo-text-note">段落</span>
...
<div class="demo-type-example">
<span class="demo-text-note">图片</span>
...
<div class="demo-type-example">
<span class="demo-text-note">较小字体</span>
...
<h3 class="demo-panel-title">色板</h3>
...
<h6 class="palette-headline">色板</h6>
...
<h3 class="demo-panel-title">图标 <small>(70)</small></h3>
...
<h3 class="demo-panel-title">社会化分享图片 <small>(27)</small></h3>
<div class="demo-icons">
<div class="demo-content">
...
<h3 class="demo-panel-title mbl pbl">实例</h3>
...
<a href="https://github.com/designmodo/Flat-UI/archive/master.zip" class="btn btn-primary btn-lg btn-block">下载</a>
<p class="demo-download-text">喜欢，分享及评论是我们的动力!</p>
</div>
</div> 
</div> 
<footer>
...
<p>Flat UI 由<a href="http://www.runoob.com/">w3cschool菜鸟教程</a>翻译整理</p>
</div> 
<div class="col-xs-5">
<div class="footer-banner">
<h3 class="footer-title">获取 Flat UI Pro（收费）</h3>
<ul>
...
<div id="site-navbar" style="position: absolute; top: -4px; left: -3px; border: 0; z-index: 2000;padding:0;margin:0;"><a href="http://www.runoob.com" title="菜鸟教程" style="background:none;"><img src="return-back.png" style="padding:0;margin:0;border:0; -webkit-box-shadow: none;-moz-box-shadow: none;box-shadow: none;"></a></div>
  ...
  s.parentNode.insertBefore(hm, s);
    ...
    public function filter(){
        ...
        return collect($domCrawler->filterXpath('//a | //link[@rel="next" or @rel="prev"]')->links())
            ...
            ->filter()
            ->each(function ( $url) use ($foundOnUrl) {
